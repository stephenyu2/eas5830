...
def connect_to_eth():
	url = "https://mainnet.infura.io/v3/36ae5171512d47b8a2eb74cdfdfa2cb4"  # FILL THIS IN
...
def connect_with_middleware(contract_json):
	...
	bnburl = "https://bsc-testnet.publicnode.com"
	w3 = Web3(HTTPProvider(bnburl))
...
def is_ordered_block(w3, block_num):
	...
	# TODO YOUR CODE HERE
	gasPriceTrans = 0.0
	prevTranGas = math.inf 
	for trans in block.transactions: 
		if trans['type'] == 2:
			gasPriceTrans = gasPriceTrans = min(trans['maxFeePerGas'], trans['maxPriorityFeePerGas'] + block['baseFeePerGas'])
		else:
